...
class TestNewRewardWeights:
    ...
    def test_total_reward_weight_count(self):
        """26 reward weights: v1.43 base (20) + v1.44 additions (sharpe_threshold[_bonus], overtrade_penalty_threshold/scale, risk_reward_bonus_scale, calmar_bonus_scale)."""
        assert len(DEFAULT_REWARD_WEIGHTS) == 26
