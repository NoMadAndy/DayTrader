          ...
          <div className="flex items-center gap-2">
            {authState.isAuthenticated ? (
              ...
              >
                ...
                <span className="hidden sm:inline text-sm text-gray-300">{authState.user?.username}</span>
              </Link>
            ) : (
              <Link
                to="/settings"
                className="flex items-center gap-2 px-3 py-2 rounded-lg text-gray-400 hover:text-white hover:bg-slate-700/50 transition-colors"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
