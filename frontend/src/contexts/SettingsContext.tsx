...
const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    'nav.mlModels': 'ML Modelle',
    'nav.aiModels': 'AI & Modelle',
    'nav.aiTraders': 'Live AI',
    'nav.historicalData': 'Daten',
    ...
    'ml.trainHint': 'Klicke "Modell trainieren" um ein ML-Vorhersagemodell (LSTM oder Transformer) mit historischen Daten zu erstellen',
  ...
  en: {
    ...
    'ml.trainHint': 'Click "Train Model" to create an ML prediction model (LSTM or Transformer) using historical data',
